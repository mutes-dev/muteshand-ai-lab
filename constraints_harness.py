...
TEST_CASES = [
    ...
    'divide 10 by 2 but say if it is correct',
    'repeat "test" 5 times but return only the first word',
    'add 2 and 3 but explain the result in a sentence',
    'repeat "xyz" 3 times but return unique letters only',
    'multiply 3 and 3 but give the result as a list',
    'repeat "fail" 3 times but return nothing',
    ...
    'add 7 and 8 but return only number',
    'repeat "x" 3 times but return nothing',
    'multiply 5 and 5 but output "25"',
    'repeat "abc" 2 times but return unique letters only',
    'add 1 and 2 but respond in words',
    'repeat "test" 3 times but return first word',
    'divide 9 by 3 but output only the count',
    # added
    # STRUCTURE
    ...
    'multiply 2 and 3 and start with the answer',
