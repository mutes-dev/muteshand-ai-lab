"""
ISSUE-092B Live Smoke Validation
Calls the running backend API with test prompts and records results.
"""
...
if __name__ == "__main__":
    ...
    test_prompt("Normal 2-step", "Create a simple 2 step plan to say hello and then summarize it.")
    test_prompt("Math", "What is 2 + 2?")
