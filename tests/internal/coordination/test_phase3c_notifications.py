...
VALIDATES:
  - Notification system
  - SUCCESS notification on step success
  - ERROR notification on step failure
  - GOVERNANCE notification on retry/escalation
  - Notifications are output only
  - Failure isolation
ENTRYPOINT: run_workflow
DIRECT_INTERNAL_CALLS:
  - notification_manager internals
MONKEYPATCH_USAGE: NONE
MOCKING_POLICY: REAL_EXECUTION
TEST_INTENT: BEHAVIORAL_VALIDATION
ARCHITECTURAL_SCOPE: Notification system
