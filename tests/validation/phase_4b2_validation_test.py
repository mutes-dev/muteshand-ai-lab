...
VALIDATES:
  - Active workflow foundation
  - Single active workflow context
  - Workflow context propagation
  - Background workflow selection
  - API workflow_id inclusion
...
ARCHITECTURAL_SCOPE: Active workflow foundation
