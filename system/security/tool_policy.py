...
TOOL_METADATA: Dict[str, Dict[str, Any]] = {
    ...
    "semantic_transform": {"read_only": True,  "idempotent": True,  "mutating": False, "external_call": False, "high_risk": False, "requires_approval": False, "disabled_in_plan_mode": False, "overrideable_with_user_control": False, "provider": None, "destination": None, "data_leaving_system": None, "privacy_classification": "local_computation", "reversibility": "read_only_no_state_change", "side_effect_summary": "performs local text summarization, explanation, or key-point extraction using chunked LLM calls", "confirmation_text_template": "This step wants to use `semantic_transform` locally. No data leaves the system."},
    "self_test_system":  {"read_only": True,  "idempotent": True,  "mutating": False, "external_call": False, "high_risk": False, "requires_approval": False, "disabled_in_plan_mode": False, "overrideable_with_user_control": False, "provider": None, "destination": None, "data_leaving_system": None, "privacy_classification": "local_system_read", "reversibility": "read_only_no_state_change", "side_effect_summary": "tests and verifies integrity of tools and agents locally", "confirmation_text_template": "This step wants to use `self_test_system` locally. No data leaves the system."},
}
